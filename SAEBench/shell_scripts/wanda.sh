...
#             --output_folder "wanda/${checkpoint}/eval_results/absorption" \
#             --artifacts_path "artifacts/wanda/${checkpoint}" \
#             --model_name ${model_name} --checkpoint "/research/nfs_khalili_17/gupte.31/llama/models/wanda/unstructured/${checkpoint}" --force_rerun || {
...
for checkpoint in "${checkpoints[@]}"; do
    for sae_block_pattern in "${sae_block_patterns[@]}"; do
        ...
        --output_folder "wanda/${checkpoint}/eval_results/core" \
        --exclude_special_tokens_from_reconstruction --verbose --llm_dtype ${llm_dtype} \
        --checkpoint "/research/nfs_khalili_17/gupte.31/llama/models/wanda/unstructured/${checkpoint}" || {
...
#         --output_folder "wanda/${checkpoint}/eval_results" \
#         --artifacts_path "artifacts/wanda/${checkpoint}" \
#         --checkpoint "/research/nfs_khalili_17/gupte.31/llama/models/wanda/unstructured/${checkpoint}" --force_rerun || {
